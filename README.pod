...
This is the I<README> for the L<Mojo::Promise::Role::Any> Perl module.
...
To read about L<Mojo::Promise::Role::Any>, look at the embedded documentation
in the module itself. Inside the distribution, you can format it
with L<perldoc|http://perldoc.perl.org/perldoc.html>:

	% perldoc lib/Mojo/Promise/Role/Any
